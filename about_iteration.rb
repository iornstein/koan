...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # takes one argument and a block which takes in |cumulation, next_item| and applies
    # the code in the block to accumulate all the items, starting with the first injection
  end
  ...
  #
  # File.open returns a range. I think that has something to do with it
